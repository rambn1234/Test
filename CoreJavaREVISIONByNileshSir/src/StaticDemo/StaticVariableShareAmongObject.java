...
public class StaticVariableShareAmongObject{
	   ...
	   {
		   StaticVariableShareAmongObject ob1 = new StaticVariableShareAmongObject();
		   StaticVariableShareAmongObject ob2 = new StaticVariableShareAmongObject();
